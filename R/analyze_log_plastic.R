#' Analyze the linear regression of log(Total Plastic Collected) on Mean Annual Temperature.
#'
#' @return A gt table with simple linear regression coefficient estimates, standard errors, t-tests, p-values, and model fit statistics.
#'
#' @importFrom stats lm
...
#'
#' @export
analyze_log_plastic <- function() {

  plastic.fit <- lm(log(grand_total)~AnnualMeanTemp, data = load_plastic_data())
